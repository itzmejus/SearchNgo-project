...
function Admin() {
    ...
    useEffect(() => {
        Axios.get("http://localhost:5000/admin/viewAdmin").then((response) => {
        ...
        <div>
            <div>
                <div className="widgetLg">
                    <h3 className="widgetLgTitle">All Admins</h3>
                ...
                <div className="widgetLg" style={{ textAlign: "center" }}>
                    <Link to="/admin/adduser">
                        <button className="userListEdit">Add Adminstrator</button>
                    </Link>
                </div>
            </div>
        </div>
